...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests().requestMatchers("/saveTelephone").hasAnyRole("ADMIN","AGENT");
        ...
        httpSecurity.authorizeRequests()
                ...
                .hasAnyRole("ADMIN");
        httpSecurity.authorizeRequests().anyRequest().authenticated(); // use authorizeRequests() instead of authorizeHttpRequests()
